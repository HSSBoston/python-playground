...
print(favMovie + " is rated 86 points higher than the lowest rated movie.")
print()
...
print(
  "According to the histogram, many action & adventure movies are rated between 60 and 64%."
)
...
print(
  "According to the scatter plot, there is a positive correlation between critic ratings and audience ratings for action & adventure movies."
)
print()
